          ...
          <div>
            <div className="margin-right-38">
              <Link
                ...
                style={{ textDecoration: "none" }}
              >
                <i className="pi pi-user icon"></i>&nbsp;<span className="text">Información</span>
              </Link>
            </div>
            ...
            <div className="margin-right-38">
              <Link
                ...
                style={{ textDecoration: "none" }}
              >
                <i className="pi pi-search-plus icon"></i>&nbsp;<span className="text">Inscribir Materias</span>
              </Link>
            </div>
            ...
            <div className="margin-right-38">
              <Link
                ...
                style={{ textDecoration: "none" }}
              >
                <i className="pi pi-book icon"></i>&nbsp;<span className="text">Materias Inscritas</span>
              </Link>
            </div>
          </div>
        )}
          ...
          <div>
            <div className="margin-right-38">
              <button
                ...
                href="#collapse-1"
              >
                <i className="far fa-user icon"></i>&nbsp;<span className="text">Estudiantes</span>
              </button>
                ...
                <div>
                  <button className="my-custom-button text-white">
                    <Link
                      ...
                      style={{ textDecoration: "none" }}
                    >
                      <i className="pi pi-save icon"></i>&nbsp;<span className="text">Guardar</span>
                    </Link>
                  </button>
                </div>
              </div>
            ...
            <div className="margin-right-38">
              <button
                ...
                href="#collapse-2"
              >
                <i className="far fa-file-alt icon"></i>&nbsp;<span className="text">Materias</span>
              </button>
            ...
            <div className="margin-right-38">
              <button
                ...
                href="#collapse-3"
              >
                <i className="far fa-address-book icon"></i>&nbsp;<span className="text">Grupos</span>
              </button>
